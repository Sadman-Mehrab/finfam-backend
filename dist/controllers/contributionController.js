...
const createContribution = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const contributionDoc = yield models_1.ContributionModel.create([{
        ...
        const updatedGoal = yield models_1.GoalModel.findByIdAndUpdate(goalId, {
...
const getGoalContributions = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const contributionDoc = yield models_1.ContributionModel.find({ goal: goalId });
